...
pathFile = "data/VICONTRAB_DEL/"
# pathFile = "Nature_Tra_data/Nature_Tra_New/"

Files = sorted(glob.glob(pathFile+ "*.csv"))
...
# ax.text(71, 55, "F$_{N}$ = 12", fontsize = 20)
# ax.text(71, 50, "R$_{F}$ = 48%", fontsize = 20)
